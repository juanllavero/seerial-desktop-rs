	...
	(
		...
		if (collapsible === 'none') {
			return (
				<div
					className={cn(
						'bg-sidebar text-sidebar-foreground flex h-full w-[--14rem] flex-col',
						className
					)}
					ref={ref}
					{...props}
		...
		return (
			...
			>
				...
				<div
					className={cn(
						'relative h-svh w-[--14rem] bg-transparent transition-[width] duration-200 ease-linear',
				...
				<div
					className={cn(
						'fixed inset-y-0 z-10 h-svh w-[14rem] transition-[left,right,width] duration-200 ease-linear md:flex',
						side === 'left'
	...
	return (
		<main
			...
			className={cn(
				...
				state === 'expanded' && 'ml-56',
				state === 'collapsed' && 'ml-14',
...
>(({ className, asChild = false, ...props }, ref) => {
	...
	return (
		<Comp
			...
			className={cn(
				'text-sidebar-foreground ring-sidebar-ring hover:bg-accent hover:text-accent-foreground absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
const sidebarMenuButtonVariants = cva(
	'peer/menu-button flex w-full cursor-pointer items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-accent hover:text-accent-foreground focus-visible:ring-2 active:bg-accent active:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-accent data-[active=true]:font-medium data-[active=true]:text-accent-foreground data-[state=open]:hover:bg-accent data-[state=open]:hover:text-accent-foreground group-data-[collapsible=icon]:!size-10 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-8 [&>svg]:shrink-0',
	{
		variants: {
			variant: {
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
	...
	return (
		<Comp
			...
			className={cn(
				'text-sidebar-foreground ring-sidebar-ring hover:bg-accent hover:text-accent-foreground peer-hover/menu-button:text-accent-foreground absolute top-1.5 right-1 m-1 flex aspect-square w-5 items-center justify-center rounded-md p-0.5 outline-hidden transition-transform focus-visible:ring-2 [&>svg]:size-6 [&>svg]:shrink-0',
				// Increases the hit area of the button on mobile.
				'after:absolute after:-inset-2 after:md:hidden',
